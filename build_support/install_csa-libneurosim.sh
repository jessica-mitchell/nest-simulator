...
# Install libneurosim
git clone --branch v1.2.0 --depth 0 "https://github.com/INCF/libneurosim.git" libneurosim.src
...
# Install csa
git clone --branch v0.1.13 --depth 0 "https://github.com/INCF/csa.git" csa.src
pushd csa.src
